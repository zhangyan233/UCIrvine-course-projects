        ...
        try {
            ...
            while (true) {
                ...
                if (sChoice.equals("6")) {
                    ...
                    // Announce the command event #8 with student ID, course ID, and course section.
                    EventBus.announce(EventBus.EV_SHOW, "\n");
                    EventBus.announce(EventBus.EV_CourseConflict,sSID + " " + sCID + " " + sSection);

                    //inform overbook handler to check whether the lecture is overbooked by 3 students
//                    EventBus.announce(EventBus.EV_SHOW, "\n");
                    EventBus.announce(EventBus.EV_OVERBOOK,sCID+" "+sSection);
                    continue;
                }
