...
public class EventBus {
    ...
    /**
     * command event #7 definition: check whether a course is overbooked by over 3 students*
     */
    public static final  int EV_OVERBOOK=7;

    /**
     * command event #8 definition: check whether the course is conflict with other lectures registered by the student*
     */
    public static  final  int EV_CourseConflict=8;
